              ...
              <div className="profile-box">
                ...
                <div className="profile-info">
                  <ul className="list clearfix">
                    ...
                    <li><a href="appointment.html" className="current"><i className="fas fa-calendar-alt" />Qəbul Siyahısı</a></li>
              ...
              <div className="content-container">
                <div className="outer-container">
                  <div className="appointment-list">
                    <div className="upper-box clearfix">
                      ...
                      <div className="select-box pull-right">
                        <select className="wide">
                          ...
                          <option value={1} >Qəbul edilib</option>
                          <option value={4}>İmtina edilib</option>
                        </select>
                      </div>
                    </div>
                    <div className="single-item">
                      <figure className="image-box"><img src="assets/images/resource/appointment-1.jpg" alt="" /></figure>
                      <div className="inner">
                        <h4>Şamil Qurbanlı</h4>
                        <ul className="info-list clearfix">
                          <li><i className="fas fa-clock" />15 Oct 2024, 09:30AM</li>
                          <li><i className="fas fa-hourglass-start" />Kardiologiya testi, Diabet diaqnozu</li>
                          <li><i className="fas fa-envelope" /><a href="mailto:shamil.gurbanli@mail.com">shamil.gurbanli@mail.com</a></li>
                          <li><i className="fas fa-phone" /><a href="tel:123456789">+994 12 345 67 89</a></li>
                        </ul>
                        <ul className="confirm-list clearfix">
                          <li><i className="fas fa-check"></i>Qəbul et</li>
                          <li><i className="fas fa-times"></i>İmtina et</li>
                        </ul>
                      </div>
                    </div>
                    <div className="single-item">
                      <figure className="image-box"><img src="assets/images/resource/appointment-2.jpg" alt="" /></figure>
                      <div className="inner">
                        <h4>Şamil Qurbanlı</h4>
                        <ul className="info-list clearfix">
                          <li><i className="fas fa-clock" />15 Oct 2024, 09:30AM</li>
                        ...
                        <ul className="confirm-list clearfix">
                          <li><i className="fas fa-check" />Qəbul et</li>
                          <li><i className="fas fa-times" />İmtina et</li>
                        </ul>
                      </div>
                    </div>
                    <div className="single-item">
                      <figure className="image-box"><img src="assets/images/resource/appointment-3.jpg" alt="" /></figure>
                      <div className="inner">
                        <h4>Şamil Qurbanlı</h4>
                        <ul className="info-list clearfix">
                          <li><i className="fas fa-clock" />15 Oct 2024, 09:30AM</li>
                    ...
                    <div className="single-item">
                      <figure className="image-box"><img src="assets/images/resource/appointment-4.jpg" alt="" /></figure>
                      <div className="inner">
                        <h4>Şamil Qurbanlı</h4>
                        <ul className="info-list clearfix">
                          <li><i className="fas fa-clock" />15 Oct 2024, 09:30AM</li>
                    ...
                    <div className="single-item">
                      <figure className="image-box"><img src="assets/images/resource/appointment-5.jpg" alt="" /></figure>
                      <div className="inner">
                        <h4>Şamil Qurbanlı</h4>
                        <ul className="info-list clearfix">
                          <li><i className="fas fa-clock" />15 Oct 2024, 09:30AM</li>
                    ...
                    <div className="single-item">
                      <figure className="image-box"><img src="assets/images/resource/appointment-6.jpg" alt="" /></figure>
                      <div className="inner">
                        <h4>Şamil Qurbanlı</h4>
                        <ul className="info-list clearfix">
                          <li><i className="fas fa-clock" />15 Oct 2024, 09:30AM</li>
                    ...
                    <div className="single-item">
                      <figure className="image-box"><img src="assets/images/resource/appointment-7.jpg" alt="" /></figure>
                      <div className="inner">
                        <h4>Şamil Qurbanlı</h4>
                        <ul className="info-list clearfix">
                          <li><i className="fas fa-clock" />15 Oct 2024, 09:30AM</li>
