        ...
        <div className="title-box centred bg-color-2">
          <div className="pattern-layer">
            ...
            <div
              className="pattern-2"
              style={{
                backgroundImage: "url(assets/images/shape/shape-71.png)",
              }}
            />
          </div>
                      ...
                      <div className="custom-controls-stacked">
                        <label className="custom-control material-checkbox">
                          ...
                          <span className="description">
                            Laborator və ya Resept Analizi
                          </span>
                        </label>
                      </div>
                    </div>
                          ...
                          <ul className="card-list clearfix">
                            <li>
                              <a href="book-appointment.html">
                                <img
                                  src="assets/images/resource/card-1.png"
                                  alt=""
                                />
                              </a>
                            </li>
                            <li>
                              <a href="book-appointment.html">
                                <img
                                  src="assets/images/resource/card-2.png"
                                  alt=""
                                />
                              </a>
                            </li>
                            <li>
                              <a href="book-appointment.html">
                                <img
                                  src="assets/images/resource/card-3.png"
                                  alt=""
                                />
                              </a>
                            </li>
                            <li>
                              <a href="book-appointment.html">
                                <img
                                  src="assets/images/resource/card-4.png"
                                  alt=""
                                />
                              </a>
                            </li>
                        ...
                        <div className="custom-check-box">
                          <div className="custom-controls-stacked">
                            <label className="custom-control material-checkbox">
                              ...
                              <span className="material-control-indicator" />
                              <span className="description">
                                Mən <a href="book-appointment.html">şərtləri</a>{" "}
                                və{" "}
                                <a href="book-appointment.html">
                                  ümumi siyasəti
                                </a>{" "}
                ...
                <div className="inner-box">
                  <div className="single-box">
                    <ul className="clearfix">
                      <li>
                        Gün<span>16/09/2024</span>
                      </li>
                      <li>
                        Vaxt<span>19:32</span>
                      </li>
                      <li>
                        Həkim<span>Dr. Nurlan İbrahimov</span>
                      </li>
                    </ul>
                  </div>
                  <div className="total-box">
                    <h5>
                      Total<span>40 AZN</span>
                    </h5>
                  </div>
                </div>
                <div className="btn-box">
                  <a href="Confirm" className="theme-btn-one">
                    Qəbul et və Ödə
