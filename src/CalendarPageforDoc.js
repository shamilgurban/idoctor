              ...
              <div className="profile-box">
                ...
                <div className="profile-info">
                  <ul className="list clearfix">
                    ...
                    <li><a href="schedule-timing.html" className="current"><i className="fas fa-clock" />Qəbul Cədvəli</a></li>
                ...
                <div className="outer-container">
                  <div className="schedule-timing">
                    <div className="title-box clearfix">
                      ...
                      <div className="right-column pull-right">
                        <span>Axtarış</span>
                        <form action="schedule-timing.html" method="post" className="search-form">
                          <div className="form-group">
                            <input type="search" name="search-field" placeholder="Bura yazın" required />
                    ...
                    <div className="inner-box">
                      <div className="inner">
                        <div className="calendar-title clearfix">
                          <div className="text pull-left">
                            <h3>Cədvəl</h3>
                          </div>
                          <div className="btn-box pull-right">
                            <a href="schedule-timing.html" className="theme-btn-one">Əlavə et<i className="icon-image" /></a>
                          </div>
                        </div>
                        <div className="calendar-inner">
                          <div className="today-box"><a href="schedule-timing.html">Bügun</a></div>
                          <ul className="date-zone clearfix">
                            <li><a href="schedule-timing.html">Ay</a></li>
                            <li><a href="schedule-timing.html">Həftə</a></li>
                            <li><a href="schedule-timing.html">Gün</a></li>
                          </ul>
                          <div className="monthly" id="appoinment_calendar" />
                        </div>
                      </div>
                    </div>
                  </div>
