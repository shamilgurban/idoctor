                ...
                <div class="profile-box">
                    ...
                    <div class="profile-info">
                        <ul class="list clearfix">
                            <li><a href="doctors-dashboard.html" class="current"><i class="fas fa-columns"></i>Dashboard</a></li>
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-xl-4 col-lg-12 col-md-12 feature-block">
                                    <div class="feature-block-two">
                                        <div class="inner-box">
                                            <div class="pattern">
                                                <div class="pattern-1" style={{backgroundImage: `url('../assets/images/shape/shape-83.png')`}}></div>
                                                <div class="pattern-2" style={{backgroundImage: `url('../assets/images/shape/shape-84.png')`}}></div>
                                            </div>
